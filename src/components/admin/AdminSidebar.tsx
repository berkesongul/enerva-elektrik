...
export function AdminSidebar() {
    ...
    return (
        <aside className="hidden lg:flex w-64 flex-col bg-[#161b22] border-r border-slate-800">
            {/* Logo */}
            <div className="flex items-center gap-3 px-6 h-16 border-b border-slate-800">
                ...
                <div>
                    <span className="text-sm font-bold text-white">ENERVA</span>
                    <span className="text-[9px] text-slate-500 block -mt-0.5 tracking-widest">ADMIN</span>
                </div>
            </div>
